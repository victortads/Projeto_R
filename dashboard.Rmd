---
title: "Dashboard sobre histórico de preços dos combustíveis de 2001 até 2015"
output: 
...
names(tabela)[1:4] <- c("Mês", "Gasolina", "Etanol", "Diesel")
...
### Gráfico com a variação de preços
...
renderDataTable({
 tabela %>%
    select(Mês, Gasolina, Etanol, Diesel) %>%
    group_by(Mês)
})
```
